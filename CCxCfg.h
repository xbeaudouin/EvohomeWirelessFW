...
static const byte CCx_registerSettings[CCX_NR_OF_CONFIGS][CCX_NR_OF_REGISTERS] PROGMEM = {

      {
        ...
        0x16,//CCx_MDMCFG2 (GFSK Sync Word and Preamable)
        0x22,//CCx_MDMCFG1 (CHANSPC_E=2 NUM_PREAMBLE=4 FEC_EN=0)
        0xF8,//CCx_MDMCFG0 (CHANSPC_M)
        0x50,//CCx_DEVIATN
        0x07,//CCx_MCSM2
        ...
        0x12,//CCx_FOCCFG (Maintain loop gain after sync word)
        0x43,//CCx_AGCCTRL2,
        0x40,//CCx_AGCCTRL1,
        0x91,//CCx_AGCCTRL0,
        0xe9,//CCx_FSCAL3,
